...
export default function HeroHome() {
  ...
  data-aos="fade-up"
>
  AI-Powered Notetaking for Productive Minds
</h1>
            ...
            <div className="mx-auto max-w-3xl">
              <p
                ...
                data-aos-delay={200}
              >
                📝 Built for thinkers on the move
                capture and structure ideas effortlessly, anytime, anywhere.
              </p>
          ...
          <ModalVideo
            ...
            video="https://mdgglnyerekfwirrikqi.supabase.co/storage/v1/object/public/videos//demoVideo.mp4"
            videoWidth={1920}
            videoHeight={1080}
          />
        </div>
